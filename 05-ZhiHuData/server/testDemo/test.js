...
Q.prototype.e = function (e) {
    ...
    u.prototype.e = function (e) {
        ...
        var r = function (r) {
            var i = new G;
            // console.log("1111",i.v(e.G, t.h, e.b, e.F));
            console.log("1111");
            return i.k = n,
                i.k[0] = r,
                i.v(e.G, t.h, e.b, e.F),
    ...
    G.prototype.D = function (e) {
        // console.log(atob(e));
        // console.log(new Buffer.from(e, 'base64').toString('binary'));
...
var get_encrypt = function (e) {
    gg = encodeURIComponent(e);
    return __g._encrypt(gg)
};

/////////////
var tttt = "client_id=c3cef7c66a1843f8b3a9e6a1e3160e20&grant_type=password&timestamp=1581610597788&source=com.zhihu.web&signature=9c1df859368a47e94d4d7dae56246a934acce6dc&username=%2B8613857230578&password=a123456&captcha=5d3r&lang=en&utm_source=&ref_source=other_https%3A%2F%2Fwww.zhihu.com%2Fsignin%3Fnext%3D%252Fhot"
console.log(get_encrypt(tttt));

//client_id=c3cef7c66a1843f8b3a9e6a1e3160e20&grant_type=password&source=com.zhihu.web&signature=93e3907b15dfaf789e1a696a71a62dcd628b4413&username=&password=&captcha=6r53&lang=en&timestamp=1581684218792