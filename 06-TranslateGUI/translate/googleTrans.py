...
from translate.googleDecrypt import get_tk
...
class GoogleTrans:
    def __init__(self, words, targetLang='en'):
        ...
        self.ua = "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/75.0.3770.100 Safari/537.36"
